...
# La clase representa al robot cuadrupedo, se utiliza para controlar y mover las patas  
class edog():
    ...
    #Subclase encargada de convertir los punto 2D en angulos para cada pata
    class leg:
        ...
        # sub clase es utilizada para manejar los servomotores de manera individual .
        class servo:
    ...
    # la funcion procesa y envia las posiciones de las cuatro patas 
    ...
    #Genera movimientos para las patas del robot, en una trayectoria definida por puntos interpolados 
    def animation3(self, x, y, t, n, gap: list[float, float, float, float]):
        ...
        while iterations < n:
            ...
            self.write(points)
            time.sleep(0.02)
    # Genera movimientos para las patas del robot con la trayectoria de los movimientos 
